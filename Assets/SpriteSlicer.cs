...
public class SpriteSlicer : MonoBehaviour
{
    ...
    public void SliceSprite(int ID)
    {
        ...
        Sprite leftHalf = CropSprite(spriteToSlice, new Rect(0, 0, spriteToSlice.rect.width / 2, spriteToSlice.rect.height));
        Sprite rightHalf = CropSprite(spriteToSlice, new Rect(spriteToSlice.rect.width / 2, 0, spriteToSlice.rect.width / 2, spriteToSlice.rect.height));
